...
function getDetail($code_cis) {
    ...
    $sql = "
        SELECT cis.code_cis, titulaires, substances, cis.denomination, forme_phamaceutique, voie_administration, cis.statut_administratif, nature_composant, valeur_smr, etat_commercialisation, taux_remboursement, prix_medicament_b, reference_dosage, lien_bpdm, libelle_statut, ciscpd.condition, type_generique, libelle_asmr, texte, lien_page_avis_ct, substances 
        FROM cis
