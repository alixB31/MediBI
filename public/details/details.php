...
if ($detail) {
    ...
    echo "<tr><th>Dosage de la substance </th><td>" . (!empty($detail['dosage_substance']) ? $detail['dosage_substance'] : "-") . "</td></tr>";
    ...
    echo "<tr><th>Type de Médicament</th><td>" . (!empty($detail['type_generique']) ? $detail['type_generique'] : "Médicament de marques") . "</td></tr>";
